...
#define ACCR_XL_MASK		(0x1f << ACCR_XL_OFFSET)
#define ACCR_XN_MASK		(0x07 << ACCR_XN_OFFSET)
#define ACCR_DMCFS_MASK		(0x03 << ACCR_DMCFS_OFFSET)
#define ACCR_HSS_MASK		(0x03 << ACCR_HSS_OFFSET)
#define ACCR_XSPCLK_MASK	(0x03 << ACCR_XSPCLK_OFFSET)
#define ACCR_SFLFS_MASK		(0x03 << ACCR_SFLFS_OFFSET)
#define ACCR_SMCFS_MASK		(0x07 << ACCR_SMCFS_OFFSET)
#define ACCR_D0CS_MASK		(0x01 << ACCR_D0CS_OFFSET)
#define ACCR_SPDIS_MASK		(0x01 << ACCR_SPDIS_OFFSET)
#define ACCR_XPDIS_MASK		(0x01 << ACCR_XPDIS_OFFSET)
...
#define PXA3xx_PM_WE_GENERIC(x)	(0x1UL << (x + 2))	/* x is in [0,13] */
...
#define PXA3xx_PM_WE_KP		(0x1UL << 21)
