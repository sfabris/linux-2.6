...
/* GPIO */
#define GPIO46_GPIO		MFP_CFG_LPM(GPIO46, AF0, PULL_HIGH)
...
/* AC97 */
#define GPIO23_AC97_nACRESET    MFP_CFG_LPM(GPIO23, AF1, PULL_HIGH)
#define GPIO24_AC97_SYSCLK      MFP_CFG_LPM(GPIO24, AF1, PULL_LOW)
#define GPIO29_AC97_BITCLK      MFP_CFG_LPM(GPIO29, AF1, PULL_LOW)
#define GPIO25_AC97_SDATA_IN_0  MFP_CFG_LPM(GPIO25, AF1, PULL_LOW)
#define GPIO27_AC97_SDATA_OUT   MFP_CFG_LPM(GPIO27, AF1, PULL_LOW)
#define GPIO28_AC97_SYNC        MFP_CFG_LPM(GPIO28, AF1, PULL_LOW)
...
#define GPIO51_CI_HSYNC_GPIO		MFP_CFG(GPIO51, AF3)
#define GPIO52_CI_VSYNC_GPIO		MFP_CFG(GPIO52, AF3)
...
#define GPIO106_USB_P2_7	MFP_CFG_X(GPIO106, AF2, DS01X, FLOAT)
#define GPIO103_USB_P2_8	MFP_CFG(GPIO103, AF2)

/* U2D UTMI */
#define GPIO38_UTM_CLK		MFP_CFG_X(GPIO38, AF1, DS08X, PULL_LOW)
#define GPIO26_U2D_RXERROR	MFP_CFG_X(GPIO26,  AF3, DS08X, PULL_LOW)
#define GPIO50_U2D_RXERROR	MFP_CFG_X(GPIO50,  AF1, DS08X, PULL_LOW)
#define GPIO89_U2D_RXERROR	MFP_CFG_X(GPIO89,  AF5, DS08X, PULL_LOW)
#define GPIO24_UTM_RXVALID	MFP_CFG_X(GPIO24,  AF3, DS08X, PULL_LOW)
#define GPIO48_UTM_RXVALID	MFP_CFG_X(GPIO48,  AF2, DS08X, PULL_LOW)
#define GPIO87_UTM_RXVALID	MFP_CFG_X(GPIO87,  AF5, DS08X, PULL_LOW)
#define GPIO25_UTM_RXACTIVE	MFP_CFG_X(GPIO25,  AF3, DS08X, PULL_LOW)
#define GPIO47_UTM_RXACTIVE	MFP_CFG_X(GPIO47,  AF2, DS08X, PULL_LOW)
#define GPIO49_UTM_RXACTIVE	MFP_CFG_X(GPIO49,  AF1, DS08X, PULL_LOW)
#define GPIO88_UTM_RXACTIVE	MFP_CFG_X(GPIO88,  AF5, DS08X, PULL_LOW)
#define GPIO53_UTM_TXREADY	MFP_CFG_X(GPIO53,  AF1, DS08X, PULL_LOW)
#define GPIO67_UTM_LINESTATE_0	MFP_CFG_X(GPIO67,  AF3, DS08X, FLOAT)
#define GPIO92_UTM_LINESTATE_0	MFP_CFG_X(GPIO92,  AF3, DS08X, FLOAT)
#define GPIO104_UTM_LINESTATE_0	MFP_CFG_X(GPIO104, AF3, DS08X, FLOAT)
#define GPIO109_UTM_LINESTATE_0	MFP_CFG_X(GPIO109, AF4, DS08X, FLOAT)
#define GPIO68_UTM_LINESTATE_1	MFP_CFG_X(GPIO68,  AF3, DS08X, FLOAT)
#define GPIO93_UTM_LINESTATE_1	MFP_CFG_X(GPIO93,  AF3, DS08X, FLOAT)
#define GPIO105_UTM_LINESTATE_1	MFP_CFG_X(GPIO105, AF3, DS08X, FLOAT)
#define GPIO27_U2D_OPMODE_0	MFP_CFG_X(GPIO27,  AF4, DS08X, PULL_LOW)
#define GPIO51_U2D_OPMODE_0	MFP_CFG_X(GPIO51,  AF2, DS08X, PULL_LOW)
#define GPIO90_U2D_OPMODE_0	MFP_CFG_X(GPIO90,  AF7, DS08X, PULL_LOW)
#define GPIO28_U2D_OPMODE_1	MFP_CFG_X(GPIO28,  AF4, DS08X, PULL_LOW)
#define GPIO52_U2D_OPMODE_1	MFP_CFG_X(GPIO52,  AF2, DS08X, PULL_LOW)
#define GPIO106_U2D_OPMODE_1	MFP_CFG_X(GPIO106, AF3, DS08X, PULL_LOW)
#define GPIO110_U2D_OPMODE_1	MFP_CFG_X(GPIO110, AF5, DS08X, PULL_LOW)
#define GPIO76_U2D_RESET	MFP_CFG_X(GPIO76,  AF1, DS08X, DRIVE_LOW)
#define GPIO95_U2D_RESET	MFP_CFG_X(GPIO95,  AF2, DS08X, DRIVE_LOW)
#define GPIO100_U2D_RESET	MFP_CFG_X(GPIO100, AF3, DS08X, DRIVE_LOW)
#define GPIO66_U2D_SUSPEND	MFP_CFG_X(GPIO66,  AF3, DS08X, PULL_LOW)
#define GPIO98_U2D_SUSPEND	MFP_CFG_X(GPIO98,  AF2, DS08X, PULL_LOW)
#define GPIO103_U2D_SUSPEND	MFP_CFG_X(GPIO103, AF3, DS08X, PULL_LOW)
#define GPIO65_U2D_TERM_SEL	MFP_CFG_X(GPIO65,  AF5, DS08X, PULL_LOW)
#define GPIO97_U2D_TERM_SEL	MFP_CFG_X(GPIO97,  AF3, DS08X, PULL_LOW)
#define GPIO102_U2D_TERM_SEL	MFP_CFG_X(GPIO102, AF5, DS08X, PULL_LOW)
#define GPIO29_U2D_TXVALID	MFP_CFG_X(GPIO29,  AF3, DS08X, PULL_LOW)
#define GPIO52_U2D_TXVALID	MFP_CFG_X(GPIO52,  AF4, DS08X, PULL_LOW)
#define GPIO69_U2D_TXVALID	MFP_CFG_X(GPIO69,  AF3, DS08X, PULL_LOW)
#define GPIO85_U2D_TXVALID	MFP_CFG_X(GPIO85,  AF7, DS08X, PULL_LOW)
#define GPIO64_U2D_XCVR_SEL	MFP_CFG_X(GPIO64,  AF5, DS08X, PULL_LOW)
#define GPIO96_U2D_XCVR_SEL	MFP_CFG_X(GPIO96,  AF3, DS08X, PULL_LOW)
#define GPIO101_U2D_XCVR_SEL	MFP_CFG_X(GPIO101, AF5, DS08X, PULL_LOW)
#define GPIO30_UTM_PHYDATA_0	MFP_CFG_X(GPIO30,  AF3, DS08X, PULL_LOW)
#define GPIO31_UTM_PHYDATA_1	MFP_CFG_X(GPIO31,  AF3, DS08X, PULL_LOW)
#define GPIO32_UTM_PHYDATA_2	MFP_CFG_X(GPIO32,  AF3, DS08X, PULL_LOW)
#define GPIO33_UTM_PHYDATA_3	MFP_CFG_X(GPIO33,  AF3, DS08X, PULL_LOW)
#define GPIO34_UTM_PHYDATA_4	MFP_CFG_X(GPIO34,  AF3, DS08X, PULL_LOW)
#define GPIO35_UTM_PHYDATA_5	MFP_CFG_X(GPIO35,  AF3, DS08X, PULL_LOW)
#define GPIO36_UTM_PHYDATA_6	MFP_CFG_X(GPIO36,  AF3, DS08X, PULL_LOW)
#define GPIO37_UTM_PHYDATA_7	MFP_CFG_X(GPIO37,  AF3, DS08X, PULL_LOW)
#define GPIO39_UTM_PHYDATA_0	MFP_CFG_X(GPIO39,  AF3, DS08X, PULL_LOW)
#define GPIO40_UTM_PHYDATA_1	MFP_CFG_X(GPIO40,  AF3, DS08X, PULL_LOW)
#define GPIO41_UTM_PHYDATA_2	MFP_CFG_X(GPIO41,  AF3, DS08X, PULL_LOW)
#define GPIO42_UTM_PHYDATA_3	MFP_CFG_X(GPIO42,  AF3, DS08X, PULL_LOW)
#define GPIO43_UTM_PHYDATA_4	MFP_CFG_X(GPIO43,  AF3, DS08X, PULL_LOW)
#define GPIO44_UTM_PHYDATA_5	MFP_CFG_X(GPIO44,  AF3, DS08X, PULL_LOW)
#define GPIO45_UTM_PHYDATA_6	MFP_CFG_X(GPIO45,  AF3, DS08X, PULL_LOW)
#define GPIO46_UTM_PHYDATA_7	MFP_CFG_X(GPIO46,  AF3, DS08X, PULL_LOW)
...
/* ULPI */
#define GPIO38_ULPI_CLK		MFP_CFG_LPM(GPIO38, AF1, PULL_HIGH)
#define GPIO30_ULPI_DATA_OUT_0	MFP_CFG_LPM(GPIO30, AF3, PULL_HIGH)
#define GPIO31_ULPI_DATA_OUT_1	MFP_CFG_LPM(GPIO31, AF3, PULL_HIGH)
#define GPIO32_ULPI_DATA_OUT_2	MFP_CFG_LPM(GPIO32, AF3, PULL_HIGH)
#define GPIO33_ULPI_DATA_OUT_3	MFP_CFG_LPM(GPIO33, AF3, PULL_HIGH)
#define GPIO34_ULPI_DATA_OUT_4	MFP_CFG_LPM(GPIO34, AF3, PULL_HIGH)
#define GPIO35_ULPI_DATA_OUT_5	MFP_CFG_LPM(GPIO35, AF3, PULL_HIGH)
#define GPIO36_ULPI_DATA_OUT_6	MFP_CFG_LPM(GPIO36, AF3, PULL_HIGH)
#define GPIO37_ULPI_DATA_OUT_7	MFP_CFG_LPM(GPIO37, AF3, PULL_HIGH)
#define GPIO33_ULPI_OTG_INTR	MFP_CFG_LPM(GPIO33, AF1, PULL_HIGH)

#define ULPI_DIR	MFP_CFG_X(ULPI_DIR, AF0, DS01X, PULL_LOW)
#define ULPI_NXT	MFP_CFG_X(ULPI_NXT, AF0, DS01X, PULL_LOW)
#define ULPI_STP	MFP_CFG_X(ULPI_STP, AF0, DS01X, PULL_LOW)
