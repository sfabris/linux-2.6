...
#define IRQ_MVED	PXA_IRQ(54)	/* MVED */
...
#define IRQ_MMC3_PXA940	PXA_IRQ(72)	/* MMC3 Controller (PXA935) */
#define IRQ_MMC4_PXA940	PXA_IRQ(73)	/* MMC4 Controller (PXA935) */
#define IRQ_MMC5_PXA940	PXA_IRQ(74)	/* MMC5 Controller (PXA935) */
