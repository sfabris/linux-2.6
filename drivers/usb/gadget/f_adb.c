...
extern struct usb_ep* pxa3xx_ep_autoconfig(struct usb_gadget *gadget,
				...
				struct usb_endpoint_descriptor *out_desc)
{
	...
	ep = pxa3xx_ep_autoconfig(cdev->gadget, in_desc, 1, adb_interface_desc.bInterfaceNumber, adb_interface_desc.bAlternateSetting);
	if (!ep) {
	...
	ep = pxa3xx_ep_autoconfig(cdev->gadget, out_desc, 1, adb_interface_desc.bInterfaceNumber, adb_interface_desc.bAlternateSetting);
	if (!ep) {
